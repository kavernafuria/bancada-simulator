/**
 * Procedural Web Audio synthesizer for stadium drum rhythm & chants
 */
class RhythmSoundEngine {
  ...
  private playDrumPattern(beat: number, time: number) {
    ...
    if (beat % 4 === 0) {
      const melodyNotes = [220, 261.63, 293.66, 329.63];
...
export const soundSynthesizer = new RhythmSoundEngine();
