...
import { findClosestPointOnPath } from './mathPath';
import { soundEngine } from './audio';
import { FlareParticlesCanvas } from './FlareParticlesCanvas';
import { StadiumTorcidaFlag } from './StadiumTorcidaFlag';
import { AlertTriangle, Sparkles, Timer, Users, Eye, Flame, CheckCircle2, ShieldAlert } from 'lucide-react';
...
export const PathTraceCanvas: React.FC<PathTraceCanvasProps> = ({
  ...
  return (
    <div
      ...
      className="relative w-full h-[460px] md:h-[520px] bg-neutral-950 rounded-2xl overflow-hidden border-2 border-neutral-800 select-none shadow-2xl flex flex-col"
    >
      <StadiumTorcidaFlag
      ...
      >
        <div className="flex items-center space-x-3">
          <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold bg-red-600/30 text-red-400 border border-red-500/40">
            Etapa {currentRound} / {totalRounds}
          </span>
