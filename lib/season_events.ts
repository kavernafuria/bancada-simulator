...
const PERIOD_4_EVENTS: EventTemplate[] = [
  ...
  },
  {
    ...
    title: "Reunião de Cúpula com as Torcidas Aliadas",
    contextNarrative: "Delegações de alto escalão das torcidas irmãs do eixo interestadual chegam à capital para traçar estratégias de apoio e proteção mútua.",
    choices: [
      {
        id: "BANQUETE_QUADRA_ESCOLTA",
        text: "Feijoada Oficial na Quadra e Comboio Fechado pela Cidade (-R$ 10.000)",
        cost: 10000,
        statEffects: { poder_pista: 8, caravana: 8 },
        stateEffects: { respeito_nacional: 15, moral: 8 },
        log: "Acolhimento de primeira classe estreitou a união militar e logística entre as torcidas.",
        formattedDeltas: [
          { label: "Respeito Nacional", value: "+15", isPositive: true },
          { label: "Poder de Pista", value: "+8", isPositive: true },
          { label: "Caravana", value: "+8", isPositive: true },
          { label: "Investimento", value: "-R$ 10.000", isPositive: false },
        ],
      },
      {
      ...
      {
        id: "ISOLAMENTO_DIPLOMATICO",
        text: "Manter Distanciamento e Focar Exclusivamente nas Cores Locais (R$ 0)",
        cost: 0,
        statEffects: { contingente: 4, caravana: -4 },
        stateEffects: { respeito_nacional: -6, moral: 2 },
        log: "Priorizou identidade própria sem assumir guerras ou compromissos de outros estados.",
        formattedDeltas: [
          { label: "Massa Local", value: "+4", isPositive: true },
          { label: "Respeito Externo", value: "-6", isPositive: false },
        ],
      },
    ],
  },
