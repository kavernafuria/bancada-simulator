      ...
      choices: [
        {
          ...
          formattedDeltas: [
            { label: "Pressão de Bancada", value: `+${4 + (i % 3)}`, isPositive: true },
            { label: "Moral", value: `+${5 + (i % 2)}`, isPositive: true },
            { label: "Contingente", value: "-2", isPositive: false },
        ...
        },
        {
          ...
          cost: 0,
          statEffects: { contingente: 2 + (i % 2), poder_pista: 2, autonomia_financeira: -3, pressao_bancada: -2 },
          stateEffects: { moral: 4 },
          ...
          formattedDeltas: [
            { label: "Contingente", value: `+${2 + (i % 2)}`, isPositive: true },
            { label: "Moral", value: "+4", isPositive: true },
            { label: "Autonomia Financeira", value: "-3", isPositive: false },
            { label: "Pressão de Bancada", value: "-2", isPositive: false },
          ],
        },
        {
          id: `PROC_CHOICE_C_${i}`,
        ...
        },
        {
          ...
          formattedDeltas: [
            { label: "Autonomia Financeira", value: "+4", isPositive: true },
            { label: "Pressão de Bancada", value: "-2", isPositive: false },
