...
export function getPoliceMeetingChoices(
  ...
  if (isInterior) {
    return [
      ...
      },
      {
        ...
        title: "2. Postura Combativa de Pista (Sem Recuo na Rua)",
        stance: "COMBATIVA",
        description: "Recusar acordos com a polícia regional e marchar em bloco armado no perímetro do estádio.",
        cost: 0,
        mpRiskMod: 14,
        bancadaBonus: 0,
        pistaMod: 8,
        ...
        formattedDeltas: [
          ...
          { label: "Confrontos de Rua", value: "Desbloqueados", isPositive: true },
        ],
        meetingLog: "Manteve postura combativa no batalhão regional, recusando recuos de rua.",
      },
      {
  ...
  return [
    ...
    },
    {
      ...
      title: "2. Postura Combativa de Pista (Sem Recuo na Rua)",
      stance: "COMBATIVA",
      description: "Recusar concessões ao Choque e garantir a marcha livre do bonde pelas avenidas rumo ao confronto direto.",
      cost: 0,
      mpRiskMod: 15,
      bancadaBonus: 0,
      pistaMod: 10,
      ...
      meetingLog: "Manteve postura irredutível e combativa na reunião, ordenando a marcha livre do bonde pela rua.",
    },
    {
