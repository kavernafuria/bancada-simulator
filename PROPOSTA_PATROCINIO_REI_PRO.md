...
```mermaid
graph TD
    A["👑 Rei PRO - Confecção Oficial"] --> B["🏬 Loja Social da Torcida"]
    A --> C["🏟️ Minigames de Festa & Arquibancada"]
    A --> D["🚌 Caravana & Sub-sedes"]
    A --> E["📣 Painéis & Publicidade In-Game"]

    B --> B1["Confecção de Camisas & Agasalhos de Bonde"]
    B --> B2["Bônus de Arrecadação Financeira na Loja"]

    C --> C1["Bandeirões 3D & Faixas de Mastro Rei PRO"]
    C --> C2["Vestuário da Bateria & Pista com Marca Rei PRO"]

    D --> D1["Uniformes de Caravana & Viagem"]

    E --> E1["Placas de Estádio & Banners de Quadra"]
```
